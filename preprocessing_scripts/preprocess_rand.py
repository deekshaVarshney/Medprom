...
if __name__ == '__main__':
    ...
    parser.add_argument('--HCM_datapath', default="/home1/deeksha/MedKGLM/src/Data/covid_data/HCM/", type=str,
                        required=False)
    parser.add_argument('--Icliniq_datapath', default='/home1/deeksha/MedKGLM/src/Data/covid_data/Icliniq/',
                        type=str, required=False)
    parser.add_argument('--json_datapath', default='/home1/deeksha/MedKGLM/src/Data/covid_data/json_files/',
                        type=str, required=False)
    parser.add_argument('--save', default='/home1/deeksha/MedKGLM/src/preprocessed_data/data_covid_rand/', type=str,
                        required=False)
    parser.add_argument('--merged_datapath',
                        default='/home1/deeksha/MedKGLM/src/Data/covid_data/merged/merged_file.json', type=str,
                        required=False)
    ...
    result = []
    for filename in glob.glob("/home1/deeksha/MedKGLM/src/Data/covid_data/json_files/*.json"):
