...
if __name__ == '__main__':
    ...
    parser.add_argument('--load_dir', default='weights/cdialog_rand', type=str, required=False)
    parser.add_argument('--validate_load_dir', default='../../preprocessed_data/data_cdialog_rand/validate_data.pkl',
                        type=str, required=False)
    parser.add_argument('--train_load_dir', default='../../preprocessed_data/data_cdialog_rand/train_data.pkl', type=str,
                        required=False)
    parser.add_argument('--log_dir', default='log/train_cdialog_rand.txt', type=str, required=False)
    parser.add_argument('--val_epoch_interval', default=1, type=int, required=False)
    parser.add_argument('--last_epoch_path', default="weights/covid_rand_2/", type=str, required=False)
    ...
    parser.add_argument('--finetune', default='True', type=str, required=False)
    ...
    if finetune_check == 'true' or finetune_check == 'True':
        ...
        checkpoint = torch.load(PATH + 'bestmodel.pth', map_location='cuda:2')
    ...
    if finetune_check_kg == 'true' or finetune_check_kg == 'True':
        ...
        states_dict = torch.load(os.path.join("/home1/deeksha/MedKGLM/src/models/RoBERTa/pretrained_kg/model.bin"))
