...
if __name__ == '__main__':
    ...
    parser.add_argument('--decoder_dir', default='weights/med_rand_2/bestmodel.pth', type=str, required=False)
    parser.add_argument('--test_load_dir', default='../../preprocessed_data/data_med_rand/test_data.pkl', type=str, required=False)
    parser.add_argument('--pred_save_dir', default='Results/med_rand_2/pred.txt', type=str, required=False)
    parser.add_argument('--reference_save_dir', default='Results/med_rand_2/reference.txt', type=str, required=False)
    parser.add_argument('--metric_save_dir', default='Results/med_rand_2/scores.txt', type=str, required=False)
    parser.add_argument('--output_save_dir', default='Results/med_rand_2/Out.csv', type=str, required=False)
