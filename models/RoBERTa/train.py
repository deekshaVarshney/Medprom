...
if __name__ == '__main__':
    ...
    parser.add_argument('--load_dir', default='weights/covid_rand_2', type=str, required=False)
    parser.add_argument('--validate_load_dir', default='../../preprocessed_data/data_covid_rand/validate_data.pkl',
                        type=str, required=False)
    parser.add_argument('--train_load_dir', default='../../preprocessed_data/data_covid_rand/train_data.pkl', type=str,
                        required=False)
    parser.add_argument('--log_dir', default='log/train_covid_rand_2.txt', type=str, required=False)
    parser.add_argument('--val_epoch_interval', default=1, type=int, required=False)
    parser.add_argument('--last_epoch_path', default="weights/med_rand_2/", type=str, required=False)
