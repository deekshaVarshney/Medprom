...
parser.add_argument('--load_dir', default='weights/med_rand_kg_2/bestmodel.pth', type=str, required=False)
...
parser.add_argument('--train_load_dir', default='../../preprocessed_data/data_med_rand/train_data.pkl', type=str,
                    required=False)
parser.add_argument('--save_dir', default='Results/med_rand_kg_new/ppl.txt', type=str, required=False)
